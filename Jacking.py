...
def check_date():
    ...
    target_date = datetime(2024, 5, 19).date()
...
print(f'''{B}{F}━━━━━━━━━━━━━⧪━━━━━━━━━━━━━{B}
|{Z}[+] TeleGram   : {B}nixonify    |
|{Z}[+] Instagram  : {B}pryanxhu |

𝙋𝙖𝙞𝙙 𝙏𝙤𝙤𝙡 TG - @nixonify
-------------------------------
{F}━━━━━━━━━━━━━⧪━━━━━━━━━━━━━━━━━━
     ██╗ █████╗  ██████╗██╗  ██╗██╗███╗   ██╗ ██████╗ 
     ██║██╔══██╗██╔════╝██║ ██╔╝██║████╗  ██║██╔════╝ 
...
tok = input(" \033[1;31mEnter Token : ")
iD = input(" \033[2;36mEnter Id : ")
print('\n')
...
ids=[]
def get_id():
  id=str(randrange(100000, 410737614))
  if id not in ids:
    ids.append(id)
    return id
  else:
